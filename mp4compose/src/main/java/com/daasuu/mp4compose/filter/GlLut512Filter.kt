...
class GlLut512Filter : GlFilter {
    ...
    constructor(bitmap: Bitmap) : super(GlFilter.DEFAULT_VERTEX_SHADER, FRAGMENT_SHADER) {
        this.lutTexture = bitmap
        hTex = NO_TEXTURE
    }

    constructor(resources: Resources, fxID: Int) : super(GlFilter.DEFAULT_VERTEX_SHADER, FRAGMENT_SHADER) {
